...
extern float  Target_Roll,Target_Pitch,Target_Yaw,Target_height;
...
extern float  Target_Position_X,Target_Position_Y;
...
#define DEQUE_SIZE  8	
struct HOLD_POSITION_OUTPUT
{
	float Dist_Output_buf[DEQUE_SIZE];
  uint8_t Dis_index;
};
#endif
