...
FRESULT chk_mounted (	/* FR_OK(0): successful, !=0: any error occurred */
	TCHAR **path,	/* Pointer to pointer to the path name (drive number) */
...
FRESULT f_stat (
	TCHAR *path,	/* Pointer to the file path */
	FILINFO *fno		/* Pointer to file information to return */
)
{
	FRESULT res;
...
FRESULT f_getfree (
	TCHAR *path,	/* Pointer to the logical drive number (root dir) */
...
FRESULT f_unlink (
	 TCHAR *path		/* Pointer to the file or directory path */
)
{
	FRESULT res;
	DIR dj, sdj;
...
FRESULT f_utime (
	TCHAR *path,	/* Pointer to the file/directory name */
	FILINFO *fno	/* Pointer to the time stamp to be set */
)
{
	FRESULT res;
	DIR dj;
...
FRESULT f_rename (
	TCHAR *path_old,	/* Pointer to the old name */
	TCHAR *path_new	/* Pointer to the new name */
)
{
	FRESULT res;
	DIR djo, djn;
