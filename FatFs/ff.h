...
FRESULT f_utime (TCHAR*,  FILINFO*);		/* Change times-tamp of the file/dir */
FRESULT f_rename ( TCHAR*, TCHAR*);		/* Rename/Move a file or directory */
FRESULT f_chdrive (BYTE);							/* Change current drive */
FRESULT f_chdir (TCHAR*);						/* Change current directory */
