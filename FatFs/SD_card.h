...
#define SD_CS_H() GPIO_SetBits(GPIOC, GPIO_Pin_6)
#define SD_CS_L() GPIO_ResetBits(GPIOC, GPIO_Pin_6)	

//检测卡是否插入卡槽
//PC13 = 0 无卡
//PC13 = 1 有卡
#define SD_DET() (GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_13)==Bit_SET)						   						 	 					    	  
