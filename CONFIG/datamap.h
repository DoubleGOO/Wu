...
float Position_X_Hold_P;
float Position_X_Hold_I;
float Position_X_Hold_D;

float Position_X_Speed_P;
float Position_X_Speed_I;
float Position_X_Speed_D;

float Position_Y_Hold_P;
float Position_Y_Hold_I;
float Position_Y_Hold_D;

float Position_Y_Speed_P;
float Position_Y_Speed_I;
float Position_Y_Speed_D;
